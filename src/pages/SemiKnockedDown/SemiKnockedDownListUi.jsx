...
const SemiKnockedDownListUi = ({ columns, list, fetchList, filters, setFilters, loading, categoryType, setCategoryType, categories, onCategoryChange }) => {
  const dispatch = useDispatch()
  const user = useSelector((state) => state.user)
  const id = 'create_Semi_Knocked_Down';
  const onCreateBtnClick = () => {
    dispatch(openModal(<CreateSemiKnockedDownController
      callBack={() => { fetchList() }}
...
export default SemiKnockedDownListUi