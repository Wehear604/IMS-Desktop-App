...
import ListUiPurchaseRequest from './ListUiPurchaseRequest';
import CreateControllerPurchaseRequest from './CreateControllerPurchaseRequest';
...
const ListControllerPurchaseRequest = () => {
  ...
  //   dispatch(
  //     openModal(
  //       <CreateControllerPurchaseRequest params={params} />,
  //       'md',
  //       false,
  //       'purchase-view'
  //     )
  ...
  const onCreateBtnClick = () => {
    dispatch(
      openModal(
        <CreateControllerPurchaseRequest
          id={params._id}
          // callBack={fetchList}
        />,
        'sm',
...
export default ListControllerPurchaseRequest;
