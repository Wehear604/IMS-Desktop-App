...
const ListUiPurchaseRequest = ({ onCreateBtnClick, list, setList, loading, filters, columns, setFilters }) => {

    return (
        <Paper elevation={2} sx={{ width: "100%", padding: 6 }}>
            <Box display={"flex"} flexDirection={"row"} justifyContent={"space-between"} alignItems={"center"}>
                <Box>
                    <Typography variant='h3' color={"primary"}>Purchase Requests</Typography>
                </Box>
...
export default ListUiPurchaseRequest