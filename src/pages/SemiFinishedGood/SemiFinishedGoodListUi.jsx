...
const SemiFinishedGoodListUi = ({ columns, fetchList, list, filters, setFilters, loading, categoryType, setCategoryType, categories, onCategoryChange }) => {
  const dispatch = useDispatch()
  const user = useSelector((state) => state.user)
  const id = 'create_Semi_Finished_Good';
  const onCreateBtnClick = () => {
    dispatch(openModal(<CreateSemiFinishedGoodController
    callBack={ () => { fetchList() }}
...
export default SemiFinishedGoodListUi